          ...
          <div className="mt-8 space-y-4">
            {!isSubmitted ? (
              ...
              <div className="space-y-6">
                ...
                {/* Next Step: Complete Official TESP Skills Scan */}
                {suitabilityResult && (suitabilityResult.result === "likely-suitable" || suitabilityResult.result === "may-need-development") && (
                  <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-5">
                    ...
                    <p className="text-blue-800 text-sm mb-4">
                      ...
                      To proceed, complete and submit the official TESP Skills Scan PDF for Training Provider review.
                    </p>
                    <Link href="/skills-scan">
                      <Button className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-lg font-semibold">
                        Complete Official TESP Skills Scan
                      </Button>
                    </Link>
                    <p className="text-xs text-blue-700 mt-3 text-center">
                      You&apos;ll download the official fillable PDF, complete it in Adobe Reader, and upload it for provider review.
                    </p>
                  </div>
                )}
              </div>

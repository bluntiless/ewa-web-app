...
export default function SkillsScanPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("formType", "skills-scan")
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-8 flex items-start gap-3">
          ...
          <div className="text-sm text-red-800">
            <strong>Mobile Users:</strong> Filling PDF forms on mobile devices (phones/tablets) can cause text misalignment and corruption issues. 
            We strongly recommend using a <strong>desktop or laptop computer</strong> with Adobe Acrobat Reader. 
            If you must use mobile, check your completed form carefully before submitting.
          </div>
        </div>

              ...
              <div>
                ...
                <div className="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                  <p className="text-red-800 text-sm">
                    <strong>Important - Mobile Users:</strong> Filling PDF forms on mobile devices (phones/tablets) can cause text misalignment and corruption issues. 
                    We strongly recommend using a <strong>desktop or laptop computer</strong> with Adobe Acrobat Reader for the best experience. 
                    If you must use a mobile device, please check your completed form carefully before submitting.
                  </p>
                </div>
              </div>
            </li>

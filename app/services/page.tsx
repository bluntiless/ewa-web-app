...
import { GraduationCap, FileCheck, Award, ClipboardCheck, CheckCircle } from "lucide-react"
import { MobileNav } from "@/components/mobile-nav"

export const metadata = {
  title: "Our Services - EWA Tracker Limited",
  description:
    "Professional electrical assessment and qualification services including EWA, NVQ Level 3, ECS Gold Card route, and online skills assessment tools.",
  keywords: "EWA assessment, NVQ Level 3, ECS Gold Card, electrical qualifications, skills scan, bridging exam",
}
...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      title: "NVQ Level 3 (1605) Qualification",
      description:
        "Comprehensive NVQ Level 3 Diploma in Installing Electrotechnical Systems and Equipment for career advancement in the electrical industry.",
      link: "/nvq-level-3-1605",
      buttonText: "Explore Qualification",
    ...
    },
    {
      ...
      title: "Bridging Exam Check",
      description:
        "Determine if you need bridging exams based on your existing qualifications and career goals in the electrical industry.",
      link: "/bridging-exam-check",

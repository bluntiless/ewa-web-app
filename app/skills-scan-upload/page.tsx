      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Upload your completed TESP Skills Scan PDF for Training Provider review
          </p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
          ...
          <ol className="space-y-3 text-blue-800">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Save the completed PDF to your computer</span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>Upload the completed PDF using the form below</span>
            </li>
          </ol>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          ...
          {uploadStatus === "success" ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label htmlFor="pdf">Completed TESP Skills Scan PDF *</Label>
                <div className="mt-1">
                  <label
                    htmlFor="pdf"
        ...
        {/* Link back to preliminary assessment */}
        <div className="mt-8 text-center">
          <p className="text-gray-600 text-sm">
            Not sure if you&apos;re ready? Take the{" "}
            <Link href="/candidate-check" className="text-blue-600 hover:underline">
